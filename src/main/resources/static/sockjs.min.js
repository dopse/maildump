    ...
    return function t(e, n, r) {
        ...
        5: [function (t, e, n) {
            ...
            r.prototype.addEventListener = function (t, e) {
                ...
                if (this["on" + e] && this["on" + e].apply(this, n), e in this._listeners)for (var r = this._listeners[e],
                                                                                                   i = 0; i < r.length; i++)r[i].apply(this, n)
            }, e.exports = r
        }, {}],
        6: [function (t, e, n) {
            "use strict";
        ...
        8: [function (t, e, n) {
            ...
            var r = t("./utils/url"), i = t("./utils/event"), o = t("json3"), s = t("./facade"),
                a = t("./info-iframe-receiver"), l = t("./utils/iframe"), u = t("./location");
            e.exports = function (t, e) {
                ...
                t.bootstrap_iframe = function () {
                    ...
                    var a = function (i) {
                        if (i.source === parent && ("undefined" == typeof c && (c = i.origin), i.origin === c)) {
                            var a;
                            try {
                                a = o.parse(i.data)
                            } catch (t) {
        ...
        10: [function (t, e, n) {
            ...
            var i = t("inherits"), o = t("events").EventEmitter, s = t("json3"), a = t("./transport/sender/xhr-local"),
                l = t("./info-ajax");
        ...
        11: [function (t, e, n) {
            (function (n) {
                ...
                var i = t("events").EventEmitter, o = t("inherits"), s = t("json3"), a = t("./utils/event"),
                    l = t("./transport/iframe"), u = t("./info-iframe-receiver");
        ...
        12: [function (t, e, n) {
            ...
            var i = t("events").EventEmitter, o = t("inherits"), s = t("./utils/url"), a = t("./transport/sender/xdr"),
                l = t("./transport/sender/xhr-cors"), u = t("./transport/sender/xhr-local"),
                c = t("./transport/sender/xhr-fake"), f = t("./info-iframe"), h = t("./info-ajax");
        ...
        14: [function (t, e, n) {
            (function (n) {
                ...
                t("./shims");
                var o, s = t("url-parse"), a = t("inherits"), l = t("json3"), u = t("./utils/random"),
                    c = t("./utils/escape"), f = t("./utils/url"), h = t("./utils/event"), d = t("./utils/transport"),
                    p = t("./utils/object"), v = t("./utils/browser"), m = t("./utils/log"), b = t("./event/event"),
                    y = t("./event/eventtarget"), g = t("./location"), w = t("./event/close"),
        ...
        15: [function (t, e, n) {
            ...
            var s, a = Array.prototype, l = Object.prototype, u = Function.prototype, c = String.prototype, f = a.slice,
                h = l.toString, d = function (t) {
            ...
            var g = Object("a"), w = "a" !== g[0] || !(0 in g), x = function (t) {
                var e = !0, n = !0;
            ...
            b(a, {
                forEach: function (t) {
                    var e = y(this), n = w && v(this) ? this.split("") : e, r = arguments[1], i = -1,
                        o = n.length >>> 0;
                    if (!d(t))throw new TypeError;
                    for (; ++i < o;)i in n && t.call(r, n[i], i, e)
                }
            }, !x(a.forEach));
            var _ = Array.prototype.indexOf && [0, 1].indexOf(1, 2) !== -1;
            b(a, {
                indexOf: function (t) {
                    var e = w && v(this) ? this.split("") : y(this), n = e.length >>> 0;
                    if (!n)return -1;
                    var i = 0;
            ...
            2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || "".split(/.?/).length || ".".split(/()()/).length > 1 ? !function () {
                ...
                c.split = function (e, n) {
                    ...
                    if ("[object RegExp]" !== h.call(e))return E.call(this, e, n);
                    var o, s, l, u, c = [],
                        f = (e.ignoreCase ? "i" : "") + (e.multiline ? "m" : "") + (e.extended ? "x" : "") + (e.sticky ? "y" : ""),
                        d = 0;
                    for (e = new RegExp(e.source, f + "g"), r += "", t || (o = new RegExp("^" + e.source + "$(?!\\s)", f)), n = void 0 === n ? -1 >>> 0 : i(n); (s = e.exec(r)) && (l = s.index + s[0].length, !(l > d && (c.push(r.slice(d, s.index)), !t && s.length > 1 && s[0].replace(o, function () {
            ...
            var j = c.substr, T = "".substr && "b" !== "0b".substr(-1);
            b(c, {
                substr: function (t, e) {
        ...
        17: [function (t, e, n) {
            (function (n) {
                ...
                var i = t("events").EventEmitter, o = t("inherits"), s = t("../../utils/event"),
                    a = t("../../utils/url"), l = n.XMLHttpRequest;
        ...
        20: [function (t, e, n) {
            ...
            var i = t("inherits"), o = t("./lib/ajax-based"), s = t("./receiver/eventsource"),
                a = t("./sender/xhr-cors"), l = t("eventsource");
        ...
        21: [function (t, e, n) {
            ...
            var i = t("inherits"), o = t("./receiver/htmlfile"), s = t("./sender/xhr-local"), a = t("./lib/ajax-based");
        ...
        22: [function (t, e, n) {
            ...
            var i = t("inherits"), o = t("json3"), s = t("events").EventEmitter, a = t("../version"),
                l = t("../utils/url"), u = t("../utils/iframe"), c = t("../utils/event"), f = t("../utils/random");
            i(r, s), r.prototype.close = function () {
                ...
                if (l.isOriginEqual(t.origin, this.origin)) {
                    var e;
                    try {
                        e = o.parse(t.data)
                    } catch (t) {
                ...
                this.iframeObj.post(o.stringify({windowId: this.windowId, type: t, data: e || ""}), this.origin)
            }, r.prototype.send = function (t) {
        ...
        24: [function (t, e, n) {
            ...
            var o = t("inherits"), s = t("../../utils/url"), a = t("./sender-receiver");
            o(i, a), e.exports = i
        ...
        25: [function (t, e, n) {
            ...
            var i = t("inherits"), o = t("events").EventEmitter;
        ...
        29: [function (t, e, n) {
            ...
            var i = t("inherits"), o = t("events").EventEmitter, s = t("eventsource");
        ...
        30: [function (t, e, n) {
            (function (n) {
                ...
                function r(t) {
                    a.call(this);
                    var e = this;
                    o.polluteGlobalNamespace(), this.id = "a" + l.string(6), t = s.addQuery(t, "c=" + decodeURIComponent(o.WPrefix + "." + this.id));
                ...
                var i = t("inherits"), o = t("../../utils/iframe"), s = t("../../utils/url"),
                    a = t("events").EventEmitter, l = t("../../utils/random");
        ...
        31: [function (t, e, n) {
            (function (n) {
                ...
                var i = t("../../utils/iframe"), o = t("../../utils/random"), s = t("../../utils/browser"),
                    a = t("../../utils/url"), l = t("inherits"), u = t("events").EventEmitter;
                l(r, u), r.prototype.abort = function () {
                    ...
                    if (i.id = "a" + o.string(8), i.src = t, i.type = "text/javascript", i.charset = "UTF-8", i.onerror = this._scriptError.bind(this), i.onload = function () {
                        ...
                        }, "undefined" == typeof i.async && n.document.attachEvent)if (s.isOpera()) e = this.script2 = n.document.createElement("script"), e.text = "try{var a = document.getElementById('" + i.id + "'); if(a)a.onerror();}catch(x){};",
                        i.async = e.async = !1; else {
                        try {
        ...
        33: [function (t, e, n) {
            (function (n) {
                ...
                var o, s, a = t("../../utils/random"), l = t("../../utils/url");
        ...
        34: [function (t, e, n) {
            (function (n) {
                ...
                var i = t("events").EventEmitter, o = t("inherits"), s = t("../../utils/event"),
                    a = t("../../utils/browser"), l = t("../../utils/url");
        ...
        38: [function (t, e, n) {
            ...
            function r(t, e, n) {
                if (!r.enabled())throw new Error("Transport created when disabled");
                a.call(this);
                var s = this, u = o.addPath(t, "/websocket");
                u = "https" === u.slice(0, 5) ? "wss" + u.slice(5) : "ws" + u.slice(4), this.url = u, this.ws = new l(this.url, [], n), this.ws.onmessage = function (t) {
                    ...
                    s.emit("close", t.code, t.reason), s._cleanup()
                }, this.ws.onerror = function (t) {
                    s.emit("close", 1006, "WebSocket connection broken"), s._cleanup()
                }
            }

            var i = t("../utils/event"), o = t("../utils/url"), s = t("inherits"), a = t("events").EventEmitter,
        ...
        42: [function (t, e, n) {
            (function (n) {
                ...
                var i = t("inherits"), o = t("./lib/ajax-based"), s = t("./receiver/xhr"), a = t("./sender/xhr-cors"),
                    l = t("./sender/xhr-local"), u = t("../utils/browser");
                i(r, o), r.enabled = function (t) {
                ...
                e.exports = {
                    WPrefix: "_jp", currentWindowId: null, polluteGlobalNamespace: function () {
                        ...
                        return s.src = t, s.style.display = "none", s.style.position = "absolute", s.onerror = function () {
                            ...
                            u("timeout")
                        }, 15e3), o = r.unloadAdd(l), {post: c, cleanup: l, loaded: a}
                    }, createHtmlfile: function (t, i) {
                        var o, s, a, l = ["Active"].concat("Object").join("X"), u = new n[l]("htmlfile"),
                            c = function () {
        ...
        50: [function (t, e, n) {
            ...
            e.exports = {
                string: function (t) {
                    for (var e = i.length, n = r.randomBytes(t), o = [],
                             s = 0; s < t; s++)o.push(i.substr(n[s] % e, 1));
                    return o.join("")
                }, number: function (t) {
                ...
                return {
                    filterToEnabled: function (e, n) {
                        ...
                        return e ? "string" == typeof e && (e = [e]) : e = [], t.forEach(function (t) {
                            t && ("websocket" === t.transportName && n.websocket === !1 || e.length && e.indexOf(t.transportName) === -1 || t.enabled(n) && (r.main.push(t), t.facadeTransport && r.facade.push(t.facadeTransport)))
                        }), r
                    }
                }
            }
            ...
            (function (e) {
                (function () {
                    function i(t, e) {
                        ...
                        var r = t.Number || l.Number, o = t.String || l.String, a = t.Object || l.Object,
                            u = t.Date || l.Date, c = t.SyntaxError || l.SyntaxError, f = t.TypeError || l.TypeError,
                            h = t.Math || l.Math, d = t.JSON || l.JSON;
                        "object" == typeof d && d && (e.stringify = d.stringify, e.parse = d.parse);
                        var p, v, m, b = a.prototype, y = b.toString, g = new u((-0xc782b5b800cec));
                        try {
                            g = g.getUTCFullYear() == -109252 && 0 === g.getUTCMonth() && 1 === g.getUTCDate() && 10 == g.getUTCHours() && 37 == g.getUTCMinutes() && 6 == g.getUTCSeconds() && 708 == g.getUTCMilliseconds()
                        } catch (t) {
                        }
                        if (!n("json")) {
                            var w = "[object Function]", x = "[object Date]", _ = "[object Number]",
                                E = "[object String]", j = "[object Array]", T = "[object Boolean]",
                                S = n("bug-string-char-index");
                            if (!g)var O = h.floor, C = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334],
                                A = function (t, e) {
                                    return C[e] + 365 * (t - 1970) + O((t - 1969 + (e = +(e > 1))) / 4) - O((t - 1901 + e) / 100) + O((t - 1601 + e) / 400)
                                };
                            if ((p = b.hasOwnProperty) || (p = function (t) {
                                    var e, n = {};
                                    return (n.__proto__ = null, n.__proto__ = {toString: 1}, n).toString != y ? p = function (t) {
                                ...
                                var N = {92: "\\\\", 34: '\\"', 8: "\\b", 12: "\\f", 10: "\\n", 13: "\\r", 9: "\\t"},
                                    k = "000000", I = function (t, e) {
                                        ...
                                        for (var e = '"', n = 0, r = t.length, i = !S || r > 10,
                                                 o = i && (S ? t.split("") : t); n < r; n++) {
                                        ...
                                        var a, l, u, c, h, d, b, g, w, S, C, N, k, P, U, M;
                                        try {
                                            a = e[t]
                                        } catch (t) {
                                        }
                                        if ("object" == typeof a && a)if (l = y.call(a), l != x || p.call(a, "toJSON")) "function" == typeof a.toJSON && (l != _ && l != E && l != j || p.call(a, "toJSON")) && (a = a.toJSON(t)); else if (a > -1 / 0 && a < 1 / 0) {
                                            if (A) {
                                                for (h = O(a / 864e5), u = O(h / 365.2425) + 1970 - 1; A(u + 1, 0) <= h; u++);
                                                for (c = O((h - A(u, 0)) / 30.42); A(u, c + 1) <= h; c++);
                                                h = 1 + h - A(u, c), d = (a % 864e5 + 864e5) % 864e5, b = O(d / 36e5) % 24, g = O(d / 6e4) % 60, w = O(d / 1e3) % 60, S = d % 1e3
                                            } else u = a.getUTCFullYear(), c = a.getUTCMonth(), h = a.getUTCDate(), b = a.getUTCHours(), g = a.getUTCMinutes(), w = a.getUTCSeconds(), S = a.getUTCMilliseconds();
                                            a = (u <= 0 || u >= 1e4 ? (u < 0 ? "-" : "+") + I(6, u < 0 ? -u : u) : I(4, u)) + "-" + I(2, c + 1) + "-" + I(2, h) + "T" + I(2, b) + ":" + I(2, g) + ":" + I(2, w) + "." + I(3, S) + "Z"
                                        } else a = null;
                                        if (n && (a = n.call(e, t, a)), null === a)return "null";
                                        if (l = y.call(a), l == T)return "" + a;
                                        if (l == _)return a > -1 / 0 && a < 1 / 0 ? "" + a : "null";
                                        if (l == E)return L("" + a);
                                        if ("object" == typeof a) {
                                            for (P = s.length; P--;)if (s[P] === a)throw f();
                                            if (s.push(a), C = [], U = o, o += i, l == j) {
                                                for (k = 0, P = a.length; k < P; k++)N = R(k, a, n, r, i, o, s), C.push(N === m ? "null" : N);
                                                M = C.length ? i ? "[\n" + o + C.join(",\n" + o) + "\n" + U + "]" : "[" + C.join(",") + "]" : "[]"
                                            } else v(r || a, function (t) {
                                                var e = R(t, a, n, r, i, o, s);
                                                e !== m && C.push(L(t) + ":" + (i ? " " : "") + e)
                                            }), M = C.length ? i ? "{\n" + o + C.join(",\n" + o) + "\n" + U + "}" : "{" + C.join(",") + "}" : "{}";
                                            return s.pop(), M
                                        }
                                ...
                                e.stringify = function (t, e, n) {
                                    var r, i, o, a;
                                    if (s[typeof e] && e)if ((a = y.call(e)) == w) i = e; else if (a == j) {
                                        o = {};
                                        for (var l, u = 0,
                                                 c = e.length; u < c; l = e[u++], a = y.call(l), (a == E || a == _) && (o[l] = 1));
                                    }
                                    if (n)if ((a = y.call(n)) == _) {
                                        if ((n -= n % 1) > 0)for (r = "", n > 10 && (n = 10); r.length < n; r += " ");
                                    } else a == E && (r = n.length <= 10 ? n : n.slice(0, 10));
                                    return R("", (l = {}, l[""] = t, l), i, o, r, "", [])
                                }
                            }
                            if (!n("json-parse")) {
                                var U, M, q = o.fromCharCode, D = {
                                    92: "\\",
                                    34: '"',
                                    47: "/",
                                    98: "\b",
                                    ...
                                    for (var t, e, n, r, i, o = M, s = o.length; U < s;)switch (i = o.charCodeAt(U)) {
                                        case 9:
                                        case 10:
                                        case 13:
                                        case 32:
                                        ...
                                        case 58:
                                        case 44:
                                            return t = S ? o.charAt(U) : o[U], U++, t;
                                        case 34:
                                            for (t = "@", U++; U < s;)if (i = o.charCodeAt(U), i < 32) W(); else if (92 == i)switch (i = o.charCodeAt(++U)) {
                                                case 92:
                                                case 34:
                                                case 47:
                                                case 98:
                                                ...
                                                case 114:
                                                    ...
                                                    break;
                                                case 117:
                                                    for (e = ++U, n = U + 4; U < n; U++)i = o.charCodeAt(U), i >= 48 && i <= 57 || i >= 97 && i <= 102 || i >= 65 && i <= 70 || W();
                                                    t += q("0x" + o.slice(e, U));
                                                    break;
                                                default:
                                                    W()
                                                ...
                                                if (34 == i)break;
                                                for (i = o.charCodeAt(U), e = U; i >= 32 && 92 != i && 34 != i;)i = o.charCodeAt(++U);
                                                t += o.slice(e, U)
                                            }
                                            if (34 == o.charCodeAt(U))return U++, t;
                                            W();
                                        default:
                                            if (e = U, 45 == i && (r = !0, i = o.charCodeAt(++U)), i >= 48 && i <= 57) {
                                                for (48 == i && (i = o.charCodeAt(U + 1), i >= 48 && i <= 57) && W(), r = !1; U < s && (i = o.charCodeAt(U), i >= 48 && i <= 57); U++);
                                            ...
                                            if (r && W(), "true" == o.slice(U, U + 4))return U += 4, !0;
                                    ...
                                    if ("$" == t && W(), "string" == typeof t) {
                                        ...
                                        if ("[" == t) {
                                            for (e = []; t = J(), "]" != t; n || (n = !0))n && ("," == t ? (t = J(), "]" == t && W()) : W()), "," == t && W(), e.push(B(t));
                                            return e
                                        }
                                        if ("{" == t) {
                                            for (e = {}; t = J(), "}" != t; n || (n = !0))n && ("," == t ? (t = J(), "}" == t && W()) : W()), "," != t && "string" == typeof t && "@" == (S ? t.charAt(0) : t[0]) && ":" == J() || W(), e[t.slice(1)] = B(J());
                                            return e
                                        }
                                        W()
                                    }
                                    ...
                                    var r, i = t[e];
                                    if ("object" == typeof i && i)if (y.call(i) == j)for (r = i.length; r--;)G(i, r, n); else v(i, function (t) {
                                        G(i, t, n)
                                    });
                                    return n.call(t, e, i)
                                };
                                e.parse = function (t, e) {
                                    var n, r;
                                    return U = 0, M = "" + t, n = B(J()), "$" != J() && W(), U = M = null, e && y.call(e) == w ? F((r = {}, r[""] = n, r), "", e) : n
                                }
                            }
                        }
                    ...
                    var o = "function" == typeof t && t.amd, s = {function: !0, object: !0},
                        a = s[typeof r] && r && !r.nodeType && r, l = s[typeof window] && window || this,
                        u = a && s[typeof n] && n && !n.nodeType && "object" == typeof e && e;
                    if (!u || u.global !== u && u.window !== u && u.self !== u || (l = u), a && !o) i(l, a); else {
                        var c = l.JSON, f = l.JSON3, h = !1, d = i(l, l.JSON3 = {
                            noConflict: function () {
        ...
        58: [function (t, e, n) {
            ...
            function i(t, e) {
                for (var n = (e || "/").split("/").slice(0, -1).concat(t.split("/")), r = n.length, i = n[r - 1],
                         o = !1,
                         s = 0; r--;)"." === n[r] ? n.splice(r, 1) : ".." === n[r] ? (n.splice(r, 1), s++) : s && (0 === r && (o = !0), n.splice(r, 1), s--);
                return o && n.unshift(""), "." !== i && ".." !== i || n.push(""), n.join("/")
            }

            function o(t, e, n) {
                if (!(this instanceof o))return new o(t, e, n);
                var u, f, h, d, p, v, m = c.slice(), b = typeof e, y = this, g = 0;
                for ("object" !== b && "string" !== b && (n = e, e = null), n && "function" != typeof n && (n = l.parse), e = a(e), f = r(t || ""), u = !f.protocol && !f.slashes, y.slashes = f.slashes || u && e.slashes, y.protocol = f.protocol || e.protocol || "", t = f.rest, f.slashes || (m[2] = [/(.*)/, "pathname"]); g < m.length; g++)d = m[g], h = d[0], v = d[1], h !== h ? y[v] = t : "string" == typeof h ? ~(p = t.indexOf(h)) && ("number" == typeof d[2] ? (y[v] = t.slice(0, p), t = t.slice(p + d[2])) : (y[v] = t.slice(p), t = t.slice(0, p))) : (p = h.exec(t)) && (y[v] = p[1], t = t.slice(0, p.index)), y[v] = y[v] || (u && d[3] ? e[v] || "" : ""), d[4] && (y[v] = y[v].toLowerCase());
            ...
            var s = t("requires-port"), a = t("./lolcation"), l = t("querystringify"),
                u = /^([a-z][a-z0-9.+-]*:)?(\/\/)?([\S\s]*)/i,
            ...
            }, o.extractProtocol = r, o.location = a, o.qs = l, e.exports = o
        }, {"./lolcation": 59, querystringify: 56, "requires-port": 57}],
        59: [function (t, e, n) {
            (function (n) {
                "use strict";
                ...
                e.exports = function (e) {
                    ...
                    var s, a = {}, l = typeof e;
                    if ("blob:" === e.protocol) a = new r(unescape(e.pathname), {}); else if ("string" === l) {
                        a = new r(e, {});
